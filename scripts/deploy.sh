...
# tiation-economic-reform - Enterprise Deployment Script
# Project Type: policy-platform
...
PROJECT_NAME="tiation-economic-reform"
PROJECT_TYPE="policy-platform"
DEFAULT_DOMAIN="tiation-economic-reform.surge.sh"
FEATURES="data-visualization,policy-analysis,interactive-charts,research-tools"
