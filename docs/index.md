---
layout: default
title: Tiation Economic Reform Proposal - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Economic Reform Proposal</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-economic-reform-proposal" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
![Architecture Diagram](../assets/architecture/tiation-economic-reform-proposal-architecture.svg)
...
```bash
# Build Docker image
docker build -t tiation-economic-reform-proposal .

# Run container
docker run -p 8080:8080 tiation-economic-reform-proposal
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-economic-reform-proposal)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-economic-reform-proposal/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-economic-reform-proposal/discussions)
